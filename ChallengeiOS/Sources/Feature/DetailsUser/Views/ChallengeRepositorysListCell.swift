//
//  ChallengeRepositorysListCell.swift
//  ChallengeiOS
//
...
class ChallengeRepositorysListCell: UITableViewCell {
    static let identifier = String(describing: ChallengeRepositorysListCell.self)
